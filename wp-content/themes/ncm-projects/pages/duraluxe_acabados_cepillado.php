<?php
/*
Template Name: Duraluxe - Acabados - Cepillado
*/
...
<div class="section-3 wf-section duraluxe-finishes-header cover-background header-section">
    ...
    <div class="content-block">
        <div class="subheading">acabado cepillado</div>
...
<div class="duralex-finishes wf-section" style="text-align: center">
    <iframe width="800" height="500" src="https://www.youtube.com/embed/ulPsnPKdV0k?si=F0L2Efix3TW1bNl8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
