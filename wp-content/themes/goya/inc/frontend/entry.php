...
add_filter( 'wcapf_min_price_text', function(){ 
	return $text = esc_html__('Min Price:', 'woocommerce' );
});

add_filter( 'wcapf_max_price_text', function(){ 
	return $text = esc_html__('Max Price:', 'woocommerce' );
});

add_filter( 'wcapf_search_for_text', function(){ 
	return $text = esc_html__('Search For:', 'woocommerce' );
});

add_filter( 'wcapf_order_by_text', function(){ 
	return $text = esc_html__('Order By:', 'woocommerce' );
});
