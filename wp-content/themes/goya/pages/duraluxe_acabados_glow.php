<?php
/*
Template Name: Duraluxe - Acabados - Glow
*/
...
<div class="section-3 wf-section duraluxe-finishes-header cover-background header-section">
    ...
    <div class="content-block">
        <div class="subheading">acabado glow</div>
...
<div class="duralex-finishes wf-section" style="text-align: center">
    <iframe width="800" height="500" src="https://www.youtube.com/embed/f75sFcechk4?si=K0Jz54n8HS3c2O7D" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
