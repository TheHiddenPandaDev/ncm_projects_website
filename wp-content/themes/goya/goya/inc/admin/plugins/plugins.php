...
function goya_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'goya-core',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v15-md3c8fdul3/goya-core.zip',
			'required'           => true,
			'version'            => '1.0.5',
		...
		array(
			...
			'slug'               => 'js_composer',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v15-md3c8fdul3/js_composer.zip',
			'required'           => false,
			'version'            => '6.7.0',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v15-md3c8fdul3/wc-ajax-product-filter.zip',
			'required'           => false,
			'version'            => '2.0.3.8',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v15-md3c8fdul3/revslider.zip',
			'required'           => false,
			'version'            => '6.5.11',
			'force_activation'   => false,
			'force_deactivation' => false,
