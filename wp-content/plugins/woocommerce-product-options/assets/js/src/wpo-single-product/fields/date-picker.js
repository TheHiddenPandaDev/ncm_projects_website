...
import { addMonths, addYears, addWeeks, addDays, isSameDay, isBefore, isAfter, formatISO } from 'date-fns';

const weekdayLocale = {
	shorthand: [
		_x( 'S', 'Sunday shorthand', 'woocommerce-product-options' ),
		_x( 'M', 'Monday shorthand', 'woocommerce-product-options' ),
		_x( 'T', 'Tuesday shorthand', 'woocommerce-product-options' ),
		_x( 'W', 'Wednesday shorthand', 'woocommerce-product-options' ),
		_x( 'T', 'Thursday shorthand', 'woocommerce-product-options' ),
		_x( 'F', 'Friday shorthand', 'woocommerce-product-options' ),
		_x( 'S', 'Saturday shorthand', 'woocommerce-product-options' ),
	],
	longhand: [
		__( 'Sunday', 'woocommerce-product-options' ),
		__( 'Monday', 'woocommerce-product-options' ),
		__( 'Tuesday', 'woocommerce-product-options' ),
		__( 'Wednesday', 'woocommerce-product-options' ),
		__( 'Thursday', 'woocommerce-product-options' ),
		__( 'Friday', 'woocommerce-product-options' ),
		__( 'Saturday', 'woocommerce-product-options' ),
	],
};
...
const datePicker = () => {
	...
	function disableHandler(
		...
		if ( disableToday && isSameDay( date, new Date() ) ) {
			return true;
		}
