...
<div class="duraluxe-faqs-section">

    <!-- 1 -->
    <div class="faq">
        <div class="faq-question" data-question="1">
            <div class="faq-number">01</div>
            <div class="faq-text">What makes Duraluxe Panels Anti-graffiti?</div>
        </div>
        <div class="faq-response" data-question="1">
            The special formulation of our powders make Duraluxe panels impenetrable to external pollutants, such as dirt and permanent markers / inks.
            While the cleaning of surfaces sublimated with regular powders would leave stains or blotches,
            panels with Duraluxe anti-graffiti / UV resistant properties can be cleaned easily with no traces of pollutants.
        </div>
    </div>
    ...
    <div class="faq">
        <div class="faq-question" data-question="1">
            ...
            <div class="faq-text">Can I use Duraluxe Panels for exterior signage in Melbourne, Australia?"</div>
        </div>
        <div class="faq-response" data-question="1">
            Yes, Duraluxe panels are specially formulated so they will withstand the elements and the power of the sun, regardless of the location.
            Your images will look wonderful for a long time. We offer a 5 year outdoor warranty. ( Glossy, Mate, Satin and Canvas )
        </div>
    </div>
</div>
