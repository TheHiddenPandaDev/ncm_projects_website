...
<?php include "page_template/header.php"; ?>
    ...
    <div class="general-features wf-section">
        <div class="w-layout-grid features-grid">
            <div class="feature-element"><img src="<?php echo $project_url; ?>ui/assets/images/network.svg" loading="lazy" alt="" class="feature-icon">
                <h3 class="feature-title">Equipos y procesos bajo el mismo techo</h3>
            </div>
            <div class="feature-element"><img src="<?php echo $project_url; ?>ui/assets/images/security.svg" loading="lazy" alt="" class="feature-icon">
                <h3 class="feature-title">Materias primas sostenibles y acabados de alta calidad</h3>
            </div>
            <div class="feature-element"><img src="<?php echo $project_url; ?>ui/assets/images/gear.svg" loading="lazy" alt="" class="feature-icon">
                <h3 class="feature-title">Siempre a la última en  tecnologías y técnicas</h3><img src="<?php echo $project_url; ?>ui/assets/images/unnamed.png" loading="lazy" width="114" alt="">
            </div>
        </div>
    </div>
